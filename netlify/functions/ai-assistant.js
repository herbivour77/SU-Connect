    ...
    if (ctx) {
      contextBlock = JSON.stringify({
        contact: {
          ...
          categories: ctx.contact.categories || (ctx.contact.category ? [ctx.contact.category] : []),
          gender: ctx.contact.gender,
          email: ctx.contact.email,
          phone: ctx.contact.phone,
          address1: ctx.contact.address1,
          address2: ctx.contact.address2,
          address3: ctx.contact.address3,
