...
const COLUMNS = ['contactId', 'fullName', 'category', 'gender', 'email', 'phone', 'notes', 'archived', 'createdAt'];
const HEADERS = ['Contact ID', 'Full Name', 'Category', 'Gender', 'Email', 'Phone', 'Notes', 'Archived', 'Created At'];
...
exports.handler = async (event) => {
  ...
  const rows = contacts.map((c) => [
    c.contactId, c.fullName, c.category || '', c.gender || '', c.email || '', c.phone || '',
