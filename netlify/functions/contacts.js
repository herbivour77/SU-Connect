...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === 'POST') {
    ...
    const { fullName, email, phone, category, gender, notes } = body;
    ...
    const contact = {
      ...
      // Free text, not an enum — the org can invent categories as it
      // needs them (e.g. "sponsor", "alumni"), typed straight into the
      // Add/Edit Contact form. Normalized so "Donor" and "donor" merge.
